...
shinyUI(fluidPage(
    titlePanel("Wilcoxon signed rank test"),
    sidebarLayout(
        sidebarPanel(
        ...
        mainPanel(
            tabsetPanel(
                ...
                tabPanel("Inference",
                         ...
                         p("V-VALUE: The observed test statistic: "),
                         textOutput('tvalue'),
                         p(),
                         p("P-VALUE: The probability of getting V-value this big or bigger (positive or negative) if the null hypothesis were true is: "),
                         textOutput('pvalue'),
                         p(),
                         p(),
